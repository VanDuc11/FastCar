package com.example.fastcar.Server;

public class HostApi {
    public static String API_URL = "https://fast-car-fbfb5db0fb7f.herokuapp.com";
//    public static String API_URL = "http://192.168.1.19:9000";
    public static String URL_Image = API_URL + "/public/images/";
