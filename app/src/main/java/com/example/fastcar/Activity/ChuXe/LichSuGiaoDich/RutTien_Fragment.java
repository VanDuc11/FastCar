...
public class RutTien_Fragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recyclerView_lich_su_giao_dich_ruttien);
        refreshLayout = view.findViewById(R.id.refresh_data_LSGD_ruttien);
    ...
    private void fetchData_LSGD_RutTien(String idUser) {
